...
//Городов Михаил Андреевич БББО-07-19
namespace ОСлаба2
{
    //задаем алфавит, который будет подбираться при расшифровке
    class Program
    {
      ...
      'z',
        ...
        static void Main(string[] args)
        {
            ...
            while (end == false)
            {
                Console.WriteLine("Введите кэш >");
                Hesh = Console.ReadLine();
                n = 26;
                while ((n > 25) || (n < 1))
                {
                    Console.WriteLine("Введите сколько потоков вы выделите на это >");
